...
var LinkCompaniesComponent = /** @class */ (function () {
    function LinkCompaniesComponent() {
    }
    LinkCompaniesComponent.prototype.ngOnInit = function () {
    };
...
var ManagementVacanciesComponent = /** @class */ (function () {
    function ManagementVacanciesComponent(authService) {
    ...
    ManagementVacanciesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.getjobVacan()
            .subscribe(function (resp) {
            console.log('entro a asignar la data');
            _this.vacancies = resp;
            console.log(_this.vacancies);
        });
    };
    ManagementVacanciesComponent.ctorParameters = function () { return [
    ...
    return ManagementVacanciesComponent;
}());
...
var PostulantsComponent = /** @class */ (function () {
    function PostulantsComponent() {
    }
    PostulantsComponent.prototype.ngOnInit = function () {
    };
...
var ProfileContComponent = /** @class */ (function () {
    function ProfileContComponent() {
    }
    ProfileContComponent.prototype.ngOnInit = function () {
    };
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(afAuth, router, fb, ngZone) {
        this.afAuth = afAuth;
        this.router = router;
        this.fb = fb;
        this.ngZone = ngZone;
...
var AuthService = /** @class */ (function () {
    function AuthService(afsAuth, afs) {
        ...
        this.arrayjobVacan = this.jobVacanCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (actions) { return actions.map(function (a) {
    ...
    AuthService.prototype.getjobVacan = function () {
